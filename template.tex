...
\begin{enumerate}
  ...
  \item Recreate this document (except put your name/info at the top) to get used to writing in \LaTeX and to see that types of things we can do when creating a document to convey statistical information. Make sure to commit and push your working using GitHub desktop as you finish each section.
...
This part of the midterm is due Sunday November 14 by 5p. I will not accept late submissions. Note that you may use this template to help build your introduction and methods sections, and you can use the work you did as a group during the datathon. Still, I except this submission to be your own summary and extension of that work without collaboration. 
...
9x-40&=9x-40 \tag{Combing like terms}\\
...
The result is 41.0746179. Not that I did not type the result, but I used the \verb|\Sexpr{}| command.
...
\subsection{Tables}
Below, we load and take a peek at some data about the death rates per 1000 in Virgina in 1940 \citep{molyneaux1947differences}.
\begin{knitrout}\scriptsize
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\hldef{sleep.table}\hlkwb{<-}\hlkwd{xtable}\hldef{(VADeaths ,}
              ...
              \hlkwc{caption} \hldef{=} \hlsng{"Death Rates per 100 in Virgina (1940)."}\hldef{)}
\end{alltt}
\end{kframe}
\end{knitrout}

% latex table generated in R 4.4.2 by xtable 1.8-4 package
% Tue Jan 21 16:40:02 2025
\begin{table}[H]
\centering
\begingroup\small
\begin{tabular}{rrrr}
...
\end{tabular}
\endgroup
\caption{Death Rates per 100 in Virgina (1940).} 
\label{VADeaths.tab}
\end{table}
...
White-Poor(\emph{Z}) &3.17 &1.00 &3.44 &0.0642 & 0.02 \\
Zero-Sum(\emph{Z}) &17.96 &1.00 &19.48 & $<$0.0001 & 0.03 \\
Education (\emph{Z}) &0.39 &1.00 &0.42 &0.5161 & 0.00 \\
Income(\emph{Z}) &0.16 &1.00 &0.17 &0.6817 & 0.00 \\
Democrat &9.60 &1.00 &10.42 &0.0013 & 0.02 \\
Black-Poor(\emph{Z}) &1.92 &1.00 &2.08 &0.1496 & 0.00 \\
White-Poor(\emph{Z})xZero-Sum(\emph{Z}) &7.96 &1.00 &8.63 &0.0034 & 0.01 \\
Residuals &506.92 &550.00 & & &  \\\hline
\end{tabular} \label{full.sleep.tab}\caption{ANOVA table for Case Study I.}
\end{center}
\end{table}


The \texttt{palmerpenguins} package for R \citep{palmerpenguins} provides data on adult foraging penguins near Palmer Station, Antartica. Figure \ref{plot3} is too big to fit nicely in our column-based-template above, so I've placed it here in the abstract by saving it and presenting it scaled to 0.75.
